...
`--report-binary-files`::
	In scenarios where Git detects a binary file and prints a "Binary files
	differ" message, also report whether each file in the diff was
	considered binary or text.
